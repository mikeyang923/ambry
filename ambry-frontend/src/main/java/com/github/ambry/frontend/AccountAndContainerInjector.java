...
public class AccountAndContainerInjector {
  ...
  private void accountAndContainerSanityCheck(RestRequest restRequest) throws RestServiceException {
    ...
    if (!unknownAccountContainerAllowed &&
        (Account.UNKNOWN_ACCOUNT_NAME.equals(getHeader(restRequest.getArgs(), Headers.TARGET_ACCOUNT_NAME, false))
    ...
    if (!unknownAccountContainerAllowed && (
        Container.UNKNOWN_CONTAINER_NAME.equals(targetContainerName) || (namedBlobPath != null
